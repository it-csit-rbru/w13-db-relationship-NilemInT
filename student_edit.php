                ...
                <div class="col-sm-12 col-md-9 col-lg-9">
                    ...
                    <?php
                        ...
                        if(isset($_GET['submit'])){
                            ...
                            $sql .= "std_fname='$std_fname',std_lname='$std_lname',std_ttl_id='$std_ttl_id',std_prg_id='$std_prg_id',std_sid='$std_sid' ";
                            $sql .="where std_id='$std_id' ";
                            include 'connectdb.php';
                            mysqli_query($conn,$sql);
                            mysqli_close($conn);
                            echo "แก้ไขข้อมูลนักเรียน $std_fname $std_lname เรียบร้อยแล้ว<br>";
                            echo '<a href="student_list.php">แสดงรายชื่ออาจารย์ทั้งหมด</a>';
                        }else{
                    ?>
